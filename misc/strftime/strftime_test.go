...
var formattests = []struct {
	...
	{
		"t̵̢̟̞͙̮͙̬̣̼̝͍͕̱̗͉̜̳̂͒̄̀́̕͘ḩ̧̮̬̪̘̱ͧͩ͗̿̌͋ͥ̂̾͗͑ͣͦ̂̋͢i̳͎̱͕͍͓̥̻̥̺͖̞̠̥̬͊̓̊́ͪ̎̽̇̍̚͞͝ͅs̩̥̳̞͑͂ͤ̾ͫ̈͛̈̒̋͒͟͝ïͧ͌ͩ̌҉͙̰̹̻͇̪̻̯͓̻̰͉̤̠͕̲͜ ̷̡́ͬ̑ͩͮͪ̅͌ͯ͂ͥ̈̏̋͆͏̴̝̤̮̬̰͓͎͎͉ͅ ̨̻̻͔̠̘͉͔̹͔͊̀̉ͧ́̽ͤ̀̐́͐̑̀t̓̉͛͆ͫ̏ͧ̽ͨͧͦͦ̐ͣͪ̇͏̷̡̧̧͇̰͎̥͈͓̦̯̪̙͚̲̺̺̠ͅs̲̖̥̳̯̣̣̣͎̲̫͖̤͔̝̼̼ͮ̒ͯͯ̈̈ͧ̃ͤͥ̀͘͢t̴̸̯̲̼͈͌̒̔̈́͑͐ͧͮ̀́ͧ̂͛ͯͭ̕͠ ͍̼͖̣͐̒ͧ̉ͭ͊̋̂̓̀͡%̪͍͓̪͇̭͙̹͂̑ͣ̑͒ͦ͢͜͝͠m̶̡̨̛̹̩̜̺͚͙̱̭͈̹̯̰͖̓ͣ̆͆̓ͬͦ͂͐̕ͅ ̸̧̮̘͖͈͙̲̝̟͙̱͕͓̖̞̰̈́̆͋ͩ̍̏ͦ̇̈̒̒̾̌̓͞ͅ%̶̒̀ͯ̔͆ͨͮ͂͌̏ͪ̏͆̒ͥ͌ͩ́͏̺̫̮͎̖͎̦̖͕͉̭̠̠̗̥̫ͅỲ̝̟̪̙̹͗̏̓͛͋̏͛̀͝ ̵̗͇̘̦̥͔͇̹͖̦̳̿̌̊̿̈́ͩͦ̆̓͆͌͊̍̿͘%̷̡̢̯̙͍͙̱̟̺̽̅̐̏́̇ ̟̩̗͖̺͕͍̄̿ͥͨ̽̀x̸̧̨͍͍̠̟̺̟͙ͨ̑̇ͣ̅̅̆̉͆̂͒͋̍ͤ́͡",
		"t̵̢̟̞͙̮͙̬̣̼̝͍͕̱̗͉̜̳̂͒̄̀́̕͘ḩ̧̮̬̪̘̱ͧͩ͗̿̌͋ͥ̂̾͗͑ͣͦ̂̋͢i̳͎̱͕͍͓̥̻̥̺͖̞̠̥̬͊̓̊́ͪ̎̽̇̍̚͞͝ͅs̩̥̳̞͑͂ͤ̾ͫ̈͛̈̒̋͒͟͝ïͧ͌ͩ̌҉͙̰̹̻͇̪̻̯͓̻̰͉̤̠͕̲͜ ̷̡́ͬ̑ͩͮͪ̅͌ͯ͂ͥ̈̏̋͆͏̴̝̤̮̬̰͓͎͎͉ͅ ̨̻̻͔̠̘͉͔̹͔͊̀̉ͧ́̽ͤ̀̐́͐̑̀t̓̉͛͆ͫ̏ͧ̽ͨͧͦͦ̐ͣͪ̇͏̷̡̧̧͇̰͎̥͈͓̦̯̪̙͚̲̺̺̠ͅs̲̖̥̳̯̣̣̣͎̲̫͖̤͔̝̼̼ͮ̒ͯͯ̈̈ͧ̃ͤͥ̀͘͢t̴̸̯̲̼͈͌̒̔̈́͑͐ͧͮ̀́ͧ̂͛ͯͭ̕͠ ͍̼͖̣͐̒ͧ̉ͭ͊̋̂̓̀͡%̪͍͓̪͇̭͙̹͂̑ͣ̑͒ͦ͢͜͝͠m̶̡̨̛̹̩̜̺͚͙̱̭͈̹̯̰͖̓ͣ̆͆̓ͬͦ͂͐̕ͅ ̸̧̮̘͖͈͙̲̝̟͙̱͕͓̖̞̰̈́̆͋ͩ̍̏ͦ̇̈̒̒̾̌̓͞ͅ%̶̒̀ͯ̔͆ͨͮ͂͌̏ͪ̏͆̒ͥ͌ͩ́͏̺̫̮͎̖͎̦̖͕͉̭̠̠̗̥̫ͅỲ̝̟̪̙̹͗̏̓͛͋̏͛̀͝ ̵̗͇̘̦̥͔͇̹͖̦̳̿̌̊̿̈́ͩͦ̆̓͆͌͊̍̿͘%̷̡̢̯̙͍͙̱̟̺̽̅̐̏́̇ ̟̩̗͖̺͕͍̄̿ͥͨ̽̀x̸̧̨͍͍̠̟̺̟͙ͨ̑̇ͣ̅̅̆̉͆̂͒͋̍ͤ́͡",
	},
	{
...
func TestStrfFormat(t *testing.T) {
	...
	for _, tt := range formattests {
		...
		require.Equalf(t, tt.expected, output, "%s not right", tt.format)
	}
}
...
func TestStrfFormatNotUTC(t *testing.T) {
	...
	for _, tt := range formattests {
		...
		output := Format(tt.format, tm)
		require.Equalf(t, expected, output, "%s not right", tt.format)
	}
}
