...
func (m *imap) Set(key string, value interface{}) (interface{}, bool) {
	if m.m == nil {
		m.m = new(HashMap[string, interface{}])
	}
...
func copyMapEntries(m *HashMap[int, int]) []entry[int, int] {
...
func copyMapTest(N int, m1 *HashMap[int, int], e11 []entry[int, int], deep bool) {
