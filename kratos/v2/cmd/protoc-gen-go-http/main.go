...
var (
	...
	httpTransportImportPath = flag.String("transport_import_path", "", "Custom HTTP transport import path")
)
...
func main() {
	...
	protogen.Options{
		...
		for _, f := range gen.Files {
			...
			generateFile(gen, f, *omitempty, *omitemptyPrefix, *externTemplate)
		}
		return nil
	})
}
