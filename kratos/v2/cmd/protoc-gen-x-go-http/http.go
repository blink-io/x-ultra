...
const (
	...
	transportHTTPPackage = protogen.GoImportPath("github.com/blink-io/x/kratos/v2/transport/http")
...
func generateFile(gen *protogen.Plugin, file *protogen.File, omitempty bool, omitemptyPrefix string, externTemplate string) *protogen.GeneratedFile {
	if len(file.Services) == 0 || (omitempty && !hasHTTPRule(file.Services)) {
		return nil
	}
	filename := file.GeneratedFilenamePrefix + "_http.pb.go"
	g := gen.NewGeneratedFile(filename, file.GoImportPath)
	g.P("// Code generated by protoc-gen-x-go-http. DO NOT EDIT.")
	g.P("// versions:")
	g.P(fmt.Sprintf("// - protoc-x-gen-go-http %s", release))
	...
	g.P()
	generateFileContent(gen, file, g, omitempty, omitemptyPrefix, externTemplate)
	return g
}

// generateFileContent generates the kratos errors definitions, excluding the package statement.
func generateFileContent(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, omitempty bool, omitemptyPrefix string, externTemplate string) {
	...
	for _, service := range file.Services {
		genService(gen, file, g, service, omitempty, omitemptyPrefix, externTemplate)
	}
}

func genService(_ *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, service *protogen.Service, omitempty bool, omitemptyPrefix string, externTemplate string) {
